...
export class WidgetsPage {
    ...
    async beforeRender() {
        const widgets = await codeManager.listWidgets(this.spaceId, this.appName);
        this.pageRows = (widgets).map(widget =>
            `<div class="page-item">
            <span class="page-item-name">${widget.fileName}</span>
            <div class="page-item-description-container">
            <div class="page-item-description-buttons">
                <button class="table-action-btn button-padding" data-local-action="editWidget ${widget.name}">
            ...
            <button class="table-action-btn button-padding" data-local-action="previewWidget ${widget.name}">
                Preview
            </button>
            <button data-local-action="deleteWidget ${widget.name}">
